...
Panel {
  ...
  Timer {
    ...
    interval: 1500
    repeat: true
    running: true   // ← siempre activo, así el icono de la barra tiene datos en vivo
  ...
  Item {
    ...
    function customIcon() {
      ...
      if (root.kind === "ethernet") return "󰀂"
      return "󰤮"
    }

    readonly property bool connected: root.kind !== "disconnected"
    readonly property string speedLabel: root.hasTransferStats ? root.formatRate(root.downloadRate) : "0 B/s"
    ...
    Row {
      ...
      Text {
        text: button.customIcon()
        font.family: "JetBrainsMono Nerd Font"
        font.pixelSize: 14
        font.weight: Font.Bold
        color: button.connected ? "#9ece6a" : "#f7768e"
        verticalAlignment: Text.AlignVCenter
      }

      Text {
        text: button.speedLabel
        font.family: "JetBrainsMono Nerd Font"
        font.pixelSize: 14
        font.weight: Font.Bold
        color: button.connected ? "#e0af68" : "#f7768e"
        verticalAlignment: Text.AlignVCenter
